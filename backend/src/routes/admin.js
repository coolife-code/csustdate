...
router.get('/matches/health', adminLocalAuth, adminController.getMatchingHealth)
router.post('/matches/run-weekly', adminLocalAuth, adminController.runWeeklyMatchingNow)
